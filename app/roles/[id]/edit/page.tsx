      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">
            ແກ້ໄຂປະເພດສິດ #{params.id}
          </h1>
          <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-0.5">
            ປັບປຸງຊື່ ແລະ ກຳນົດສິດທິການເຂົ້າເຖິງລະບົບ
          </p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="bg-gray-50 dark:bg-slate-800/60 border border-gray-200 dark:border-slate-700 px-3.5 py-2 rounded-xl flex items-center justify-between h-[42px]">
            ...
            <div className="space-y-2.5 pt-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {permissionModules.map((module) => (
                  <div
                    key={module.id}
                    className="p-3.5 bg-gray-50/60 dark:bg-slate-800/40 rounded-xl border border-gray-100 dark:border-slate-800 space-y-2.5 card-3d"
                  >
