        ...
        <div className="flex items-start gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              ກະລຸນາປ້ອນຂໍ້ມູນເພື່ອສ້າງຄູປອງສ່ວນຫຼຸດ ຫຼື ແຄມເປນໃໝ່.
            </p>
          </div>
        </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-400 mt-1">
                  ກຳນົດລະຫັດ ແລະ ເງື່ອນໄຂສ່ວນຫຼຸດ
                </p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full px-5 py-4 bg-[#f8fafc] dark:bg-gray-800 border-none rounded-2xl focus:ring-2 focus:ring-[#009688]/20 outline-none transition-all dark:text-white appearance-none">
                    <option>ເປີເຊັນ (%)</option>
                    <option>ຈຳນວນເງິນຄົງທີ່ (ກີບ)</option>
                  </select>
                </div>
